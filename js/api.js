...
import { supabase } from './supabaseClient.js?v=20260922e';
import { localDateStr } from './uiKit.js?v=20260922e';
 ...
 * is logged in layaway_forfeit_date_log (returned via listLayaways()'s embed) so it's
